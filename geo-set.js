...
(function() {
  var CITY_MAP = {
    ...
    'Stavropol':'Ставрополь', 'Saratov':'Саратов', 'Sochi':'Сочи',
  ...
  var KNOWN_CITIES = ['Волгоград','Москва','Санкт-Петербург','Екатеринбург','Казань','Краснодар','Ростов-на-Дону','Новосибирск','Омск','Самара','Уфа','Челябинск','Пермь','Воронеж','Красноярск','Иркутск','Владивосток','Нижний Новгород','Ставрополь','Саратов','Сочи'];
